...
var eventHubNamespaceConnectionString = listenAuthorizationRule.listKeys().primaryConnectionString
...
output eventHubConnectionString string = eventHubNamespaceConnectionString
